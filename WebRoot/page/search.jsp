...
<div id="Layer3" style="position:absolute; left:358px; top:146px; width:541px; height:85px; z-index:9"> 
  <s:if test="typeString=='用户名'">
  <s:iterator value="userLists">
  <table width="95%" border="0">
    <tr> 
      <td width="13%">昵&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;称:</td>
      <td width="87%"><s:property value="nick"/></td>
    </tr>
    <tr> 
      <td>用户名:</td>
    ...
    <tr>
      <td>关注数:</td>
      <td><s:property value="careCount"/></td>
    </tr>
    <tr> 
      <td>&nbsp;</td>
      <td>&nbsp;</td>
...
<div id="Layer4" style="position:absolute; left:355px; top:257px; width:542px; height:82px; z-index:10"> 
  <s:if test="typeString=='主题'">
  <s:iterator value="weiboLsits">
  <table width="94%" border="0">
    <tr> 
      <td width="13%">主&nbsp;&nbsp;&nbsp;&nbsp;题:</td>
      <td width="87%"><s:property value="theme"/></td>
    </tr>
    <tr> 
      <td>信&nbsp;&nbsp;&nbsp;&nbsp;息:</td>
